...
export const GenreView: React.FC = () => {
  ...
  return (
    <div className="pb-36 min-h-screen bg-[#111113] text-white select-none">
      {/* Top Header */}
      <div className="sticky top-0 z-30 px-4 pt-4 pb-3 bg-[#111113]/90 backdrop-blur-md border-b border-white/5 flex items-center justify-between">
      ...
      <div className="px-4 py-3 border-b border-white/5 bg-[#111113]/60">
