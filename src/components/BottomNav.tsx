...
export const BottomNav: React.FC = () => {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-40 bg-[#141416]/90 backdrop-blur-md border-t border-white/10 pb-safe select-none pointer-events-auto shadow-[0_-8px_32px_rgba(0,0,0,0.5)]"
    >
